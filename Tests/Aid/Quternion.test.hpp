...
UTEST(QuaternionTest, VectorRotation)
{
    CE_Kernel::Aid::Math::Vector3 v_(1.0f, 0.0f, 0.0f);
    CE_Kernel::Aid::Math::Quaternion q_ =
      CE_Kernel::Aid::Math::Quaternion::AngleAxis(
        3.14159265358979323846, CE_Kernel::Aid::Math::Vector3(0.0f, 0.0f, 1.0f)
      );
    CE_Kernel::Aid::Math::Vector3 rotated_ = q_ * v_;
    
    const float tolerance_ = 0.0001f;
    ASSERT_NEAR(rotated_.x_, 0.0f, tolerance_);
    ASSERT_NEAR(rotated_.y_, 1.0f, tolerance_);
    ASSERT_NEAR(rotated_.z_, 0.0f, tolerance_);
}
...
UTEST(QuaternionTest, OutputOperator)
{
    CE_Kernel::Aid::Math::Quaternion q_(1.5f, 2.5f, 3.5f, 4.5f);
