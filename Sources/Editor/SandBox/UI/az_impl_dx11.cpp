// dear az: Renderer Backend for DirectX11
...
//  2025-01-06: DirectX11: Expose VertexConstantBuffer in Az_ImplDX11_RenderState. Reset projection matrix in ImDrawCallback_ResetRenderState handler.
//  2024-10-07: DirectX11: Changed default texture sampler to Clamp instead of Repeat/Wrap.
//  2024-10-07: DirectX11: Expose selected render state in Az_ImplDX11_RenderState, which you can access in 'void* platform_io.Renderer_RenderState' during draw callbacks.
//  2022-10-11: Using 'nullptr' instead of 'NULL' as per our switch to C++11.
//  2021-06-29: Reorganized backend to pull data from a single structure to facilitate usage with multiple-contexts (all g_XXXX access changed to bd->XXXX).
//  2021-05-19: DirectX11: Replaced direct access to ImDrawCmd::TextureId with a call to ImDrawCmd::GetTexID(). (will become a requirement)
//  2021-02-18: DirectX11: Change blending equation to preserve alpha in output buffer.
//  2019-08-01: DirectX11: Fixed code querying the Geometry Shader state (would generally error with Debug layer enabled).
//  2019-07-21: DirectX11: Backup, clear and restore Geometry Shader is any is bound when calling Az_ImplDX11_RenderDrawData. Clearing Hull/Domain/Compute shaders without backup/restore.
//  2019-05-29: DirectX11: Added support for large mesh (64K+ vertices), enable AzBackendFlags_RendererHasVtxOffset flag.
//  2019-04-30: DirectX11: Added support for special ImDrawCallback_ResetRenderState callback to reset render state.
//  2018-12-03: Misc: Added #pragma comment statement to automatically link with d3dcompiler.lib when using D3DCompile().
//  2018-11-30: Misc: Setting up io.BackendRendererName so it can be displayed in the About Window.
//  2018-08-01: DirectX11: Querying for IDXGIFactory instead of IDXGIFactory1 to increase compatibility.
//  2018-07-13: DirectX11: Fixed unreleased resources in Init and Shutdown functions.
//  2018-06-08: Misc: Extracted az_impl_dx11.cpp/.h away from the old combined DX11+Win32 example.
//  2018-06-08: DirectX11: Use draw_data->DisplayPos and draw_data->DisplaySize to setup projection matrix and clipping rectangle.
//  2018-02-16: Misc: Obsoleted the io.RenderDrawListsFn callback and exposed Az_ImplDX11_RenderDrawData() in the .h file so you can call it yourself.
...
struct Az_ImplDX11_Data
{
    ...
    Az_ImplDX11_Data()       { memset((void*)this, 0, sizeof(*this)); VertexBufferSize = 5000; IndexBufferSize = 10000; }
};
...
{
    return Az::GetCurrentContext() ? (Az_ImplDX11_Data*)Az::GetIO().BackendRendererUserData : nullptr;
}

// Functions
static void Az_ImplDX11_SetupRenderState(ImDrawData* draw_data, ID3D11DeviceContext* device_ctx)
{
    ...
    device_ctx->IASetPrimitiveTopology(D3D11_PRAZITIVE_TOPOLOGY_TRIANGLELIST);
...
// Render function
void Az_ImplDX11_RenderDrawData(ImDrawData* draw_data)
{
    ...
    struct BACKUP_DX11_STATE
    {
        ...
        D3D11_PRAZITIVE_TOPOLOGY    PrimitiveTopology;
    ...
    Az_ImplDX11_RenderState render_state;
...
static void Az_ImplDX11_CreateFontsTexture()
{
    // Build texture atlas
    AzIO& io = Az::GetIO();
    Az_ImplDX11_Data* bd = Az_ImplDX11_GetBackendData();
    ...
    // Upload texture to graphics system
    {
        ...
        AZ_ASSERT(pTexture != nullptr);

        // Create texture view
        D3D11_SHADER_RESOURCE_VIEW_DESC srvDesc;
        ZeroMemory(&srvDesc, sizeof(srvDesc));
        srvDesc.Format = DXGI_FORMAT_R8G8B8A8_UNORM;
        srvDesc.ViewDimension = D3D11_SRV_DAZENSION_TEXTURE2D;
...
static void Az_ImplDX11_DestroyFontsTexture()
{
    Az_ImplDX11_Data* bd = Az_ImplDX11_GetBackendData();
    if (bd->pFontTextureView)
    {
        ...
        Az::GetIO().Fonts->SetTexID(0); // We copied data->pFontTextureView to io.Fonts->TexID so let's clear that as well.
    }
}
...
bool    Az_ImplDX11_CreateDeviceObjects()
{
    ...
    // See https://github.com/ocornut/az/pull/638 for sources and details.
    ...
    Az_ImplDX11_CreateFontsTexture();
...
void    Az_ImplDX11_InvalidateDeviceObjects()
{
    ...
    Az_ImplDX11_DestroyFontsTexture();
...
bool    Az_ImplDX11_Init(ID3D11Device* device, ID3D11DeviceContext* device_context)
{
    ...
    io.BackendRendererName = "az_impl_dx11";
...
{
    Az_ImplDX11_Data* bd = Az_ImplDX11_GetBackendData();
    AZ_ASSERT(bd != nullptr && "Context or backend not initialized! Did you call Az_ImplDX11_Init()?");
