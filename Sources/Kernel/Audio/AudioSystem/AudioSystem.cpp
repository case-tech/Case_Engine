    ...
    namespace Audio
    {
        namespace AudioSystem
        {
            ...
            bool AudioSystem::Initialize()
            {
                ...
                result_ = FMOD_System_Init(system_,
                                           512,
                                           FMOD_INIT_NORMAL,
                                           nullptr);
            ...
            std::shared_ptr<CE_Kernel::Audio::Sound::Sound>
            AudioSystem::CreateSound(const std::string& file_path_a,
                                     bool is_3d_a,
                                     bool loop_a)
            {
                ...
                FMOD_RESULT result_ =
                        FMOD_System_CreateSound(system_,
                                                file_path_a.c_str(),
                                                mode_,
                                                nullptr,
                                                &sound_);
                    ...
                    bool start_paused_a)
            {
                ...
                FMOD_RESULT result_ = FMOD_System_PlaySound(system_,
                                                            sound_a->GetPtr(),
                                                            nullptr,
                                                            start_paused_a,
                                                            &channel_);
                ...
                return std::make_shared<CE_Kernel::Audio::Channel::Channel>(
                        channel_);
            }

            std::shared_ptr<CE_Kernel::Audio::ChannelGroup::ChannelGroup>
            AudioSystem::CreateChannelGroup(const std::string& name_a)
            {
                FMOD_CHANNELGROUP* group_ = nullptr;
                FMOD_RESULT result_ =
                        FMOD_System_CreateChannelGroup(system_,
                                                       name_a.c_str(),
                                                       &group_);
                ...
                auto channel_group_ = std::make_shared<
                        CE_Kernel::Audio::ChannelGroup::ChannelGroup>(group_);
                channel_groups_[name_a] = channel_group_;
                return channel_group_;
            }

            void AudioSystem::Set3DSettings(float doppler_scale_a,
                                            float distance_factor_a,
                                            float rolloff_scale_a)
            {
                FMOD_System_Set3DSettings(system_,
                                          doppler_scale_a,
                                          distance_factor_a,
                                          rolloff_scale_a);
            }
                    ...
                    CE_Kernel::Audio::DSPEffect::DSPType type_a)
            {
                ...
                FMOD_RESULT result_ = FMOD_System_CreateDSPByType(system_,
                                                                  fmod_type_,
                                                                  &dsp_);
                ...
                return std::make_shared<CE_Kernel::Audio::DSPEffect::DSPEffect>(
                        dsp_);
            }
