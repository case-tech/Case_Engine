...
namespace CE_Kernel
{
    namespace Aid
    {
        namespace LuaCpp
        {
            ...
            {
                friend int u_newindex_(lua_State *L_a);
                friend int u_index_(lua_State *L_a);
                friend int u_call_(lua_State *L_a);
            ...
            public:
                ...
                virtual void SetValue(std::string& key_a, std::shared_ptr<LuaType> val_a);
