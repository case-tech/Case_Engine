...
DECL_REPORT( In,                                "in"                                                                                                            ); 
DECL_REPORT( Input,                             "input"                                                                                                         ); 
DECL_REPORT( Output,                            "output"                                                                                                        ); 
...
DECL_REPORT( FuncDeclStackUnderflow,            "function declaration stack underflow"                                                                          ); 
DECL_REPORT( CallExprStackUnderflow,            "call expression stack underflow"                                                                               ); 
DECL_REPORT( LValueExprStackUnderflow,          "l-value expression stack underflow"                                                                            ); 
...
DECL_REPORT( VarDeclStmntStackUnderflow,        "variable declaration statement stack underflow"                                                                ); 
DECL_REPORT( WritePrefixStackUnderflow,         "write prefix stack underflow"                                                                                  ); 
