...
enum
{
    ...
    STBTT_MAC_LANG_CHINESE_SAZPLIFIED = 33,
                                   ...
                                   int fontstart)
{
    ...
    } else
    {
        ...
        if (fdarrayoff)
        {
            ...
            info->fdselect = stbtt__buf_range(&b,
                                              fdselectoff,
                                              b.size - fdselectoff);
        }
                                   ...
                                   int unicode_codepoint)
{
    ...
    } else if (format == 4)
    {
...

        {
            ...
            start = ttUSHORT(data + index_map + 14 + segcount * 2 + 2
                             + 2 * item);
            last = ttUSHORT(data + endCount + 2 * item);
            if (unicode_codepoint < start || unicode_codepoint > last)
                return 0;

            offset = ttUSHORT(data + index_map + 14 + segcount * 6 + 2
                              + 2 * item);
            if (offset == 0)
    ...
    } else if (format == 12 || format == 13)
    {
        ...
        while (low < high)
        {
            ...
            stbtt_uint32 end_char = ttULONG(data + index_map + 16 + mid * 12
                                            + 4);
            ...
            {
                stbtt_uint32 start_glyph = ttULONG(data + index_map + 16
                                                   + mid * 12 + 8);
                if (format == 12)
...
STBTT_DEF int stbtt_GetCodepointShape(const stbtt_fontinfo* info,
                                      ...
                                      stbtt_vertex** vertices)
{
    return stbtt_GetGlyphShape(info,
                                  ...
                                  stbtt_vertex** pvertices)
{
    ...
    {
        *pvertices = (stbtt_vertex*)STBTT_malloc(count_ctx.num_vertices
                                                         * sizeof(stbtt_vertex),
                                                 info->userdata);
        ...
        for (sti = 0; sti < subTableCount; sti++)
        {
            ...
            case 1: {
                ...
                if (valueFormat1 == 4 && valueFormat2 == 0)
                {
                    ...
                    stbtt_uint16 pairPosOffset = ttUSHORT(table + 10
                                                          + 2 * coverageIndex);
            ...
            case 2: {
                ...
                if (valueFormat1 == 4 && valueFormat2 == 0)
                {
                    ...
                    int glyph1class =
                            stbtt__GetGlyphClass(table + classDef1Offset,
                                                 glyph1);
                    int glyph2class =
                            stbtt__GetGlyphClass(table + classDef2Offset,
                                                 glyph2);
    ...
    } else
    {
        if (hh->num_remaining_in_head_chunk == 0)
        {
            ...
            stbtt__hheap_chunk* c = (stbtt__hheap_chunk*)
                    STBTT_malloc(sizeof(stbtt__hheap_chunk) + size * count,
                                 userdata);
            if (c == NULL)
                return NULL;
            c->next = hh->head;
...
static stbtt__active_edge* stbtt__new_active(stbtt__hheap* hh,
                                             ...
                                             void* userdata)
{
    stbtt__active_edge* z = (stbtt__active_edge*)stbtt__hheap_alloc(hh,
                                                                    sizeof(*z),
                                                                    userdata);
                                          ...
                                          void* userdata)
{
    ...
    while (j < result->h)
    {
        ...
        for (s = 0; s < vsubsample; ++s)
        {
            ...
            if (active)
                stbtt__fill_active_edges(scanline,
                                         result->w,
                                         active,
                                         max_weight);
    ...
    while (e)
    {
        ...
        if (e->fdx == 0)
        {
            ...
            if (x0 < len)
            {
                if (x0 >= 0)
                {
                    stbtt__handle_clipped_edge(scanline,
                                               (int)x0,
                                               e,
                                               x0,
                                               y_top,
        ...
        } else
        {
            ...
            if (x_top >= 0 && x_bottom >= 0 && x_top < len && x_bottom < len)
            {
                if ((int)x_top == (int)x_bottom)
                {
                    ...
                    scanline[x] += stbtt__position_trapezoid_area(height,
                                                                  x_top,
                                                                  x + 1.0f,
                                                                  x_bottom,
                                                                  x + 1.0f);
                ...
                } else
                {
                    ...
                    scanline[x1] += stbtt__sized_triangle_area(area,
                                                               x1 + 1 - x_top);
                                          ...
                                          void* userdata)
{
    ...
    while (j < result->h)
    {
        ...
        if (active)
            stbtt__fill_active_edges_new(scanline,
                                         scanline2 + 1,
                                         result->w,
                                         active,
                                         scan_y_top);
...
#error "Unrecognized value of STBTT_RASTERIZER_VERSION"
    ...
    stbtt__rasterize_sorted_edges(result,
                                  e,
                                  n,
                                  vsubsample,
                                  off_x,
                              ...
                              void* alloc_context)
{
    ...
    stbrp_node* nodes = (stbrp_node*)STBTT_malloc(sizeof(*nodes) * num_nodes,
                                                  alloc_context);
    ...
    for (j = 0; j < w; ++j)
    {
        ...
        default:
            for (i = 0; i <= safe_h; ++i)
            {
                ...
                buffer[(i + kernel_width) & STBTT__OVER_MASK] =
                        pixels[i * stride_in_bytes];
                pixels[i * stride_in_bytes] = (unsigned char)(total
                                                              / kernel_width);
            }
            break;
        }
                                   ...
                                   int num_ranges)
{
    ...
    return_value = stbtt_PackFontRangesRenderIntoRects(spc,
                                                       &info,
                                                       ranges,
                                                       num_ranges,
                                                       rects);
    ...
    for (i = 0; i < nverts; ++i)
    {
        ...
        if (verts[i].type == STBTT_vcurve)
        {
            ...
            if (y > ay && y < by && x > ax)
            {
                ...
                {
                    int num_hits = stbtt__ray_intersect_bezier(orig,
                                                               ray,
                                                               q0,
                                                               q1,
                                                               q2,
...
STBTT_DEF int stbtt_CompareUTF8toUTF16_bigendian(const char* s1,
                                                 ...
                                                 int len2)
{
    return stbtt_CompareUTF8toUTF16_bigendian_internal((char*)s1,
                                                       len1,
                                                       (char*)s2,
                                                       len2);
}
