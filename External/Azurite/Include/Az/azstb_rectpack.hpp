...
#ifndef STB_INCLUDE_STB_RECT_PACK_HPP
#define STB_INCLUDE_STB_RECT_PACK_HPP
...
static stbrp__findresult stbrp__skyline_pack_rectangle(stbrp_context* context,
                                                       ...
                                                       int height)
{
    stbrp__findresult res = stbrp__skyline_find_best_pos(context,
                                                         width,
                                                         height);
    stbrp_node *node, *cur;
                               ...
                               int num_rects)
{
    ...
    for (i = 0; i < num_rects; ++i)
    {
        ...
        {
            stbrp__findresult fr = stbrp__skyline_pack_rectangle(context,
                                                                 rects[i].w,
                                                                 rects[i].h);
            if (fr.prev_link)
            {
